...
namespace EMSProject.Respository.Service
{
    public class UserService : IUser
    {
        ...
        private void SendMail(string to, string Otp)
        {
            ...
            mail.To.Add(to);
            mail.From = new MailAddress("biswajitk637@gmail.com");
            ...
            smtp.Credentials = new System.Net.NetworkCredential("biswajitk637@gmail.com", "Biswajit312@#"); // Enter seders User name and password  
            smtp.EnableSsl = true;
            smtp.Send(mail);
        ...
        public AuthoEnum AuthoEmail(SignIn model)
        {
            var user = dbContext.Users.SingleOrDefault(e => e.Email == model.Email/* && e.Password == model.Password*/);
            if (user == null)
            {
        ...
        public bool UpdatePassword(SignIn model)
        {
            var User = dbContext.Users.SingleOrDefault(e => e.Email == model.Email);
            if (User != null)
            {
